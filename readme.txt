...
Tom Dobrowolski: (http://ged.ax.pl/~tomkh)
...
------------------------------------------------------------------------------
Voxlap Engine license:

[1] Any derivative works based on Voxlap may be distributed freely through the
	 internet. I am open to commercial applications based on Voxlap, however
	 you must consult with me first to acquire a license.
