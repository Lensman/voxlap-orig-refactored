...
find_library(DIRECTINPUT_DDRAW_LIBRARY
	NAMES
	ddraw
	PATHS
	${DXSDK_DIRS} ${LIBRARY_PATH}
	HINTS
	"${DIRECTINPUT_ROOT_DIR}"
	PATH_SUFFIXES
	${_lib_suffixes})

if(DIRECTINPUT_DDRAW_LIBRARY)
	get_filename_component(_dinput_lib_dir
		${DIRECTINPUT_DDRAW_LIBRARY}
		PATH)
...
find_library(DIRECTINPUT_DINPUT_LIBRARY
	...
	dinput8
	PATHS
	${LIBRARY_PATH} ${DXSDK_DIRS}
	HINTS
	"${_dinput_lib_dir}"
	"${LIBRARY_PATH} ${DIRECTINPUT_ROOT_DIR}"
	PATH_SUFFIXES
	${_lib_suffixes})
