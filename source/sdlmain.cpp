...
/** Dummy function,  should be SDLFLip? */
...
void stopdirectdraw()
{
	...
	if (has_pbo)
	{
        ...
        glBegin(GL_QUADS);
        glNormal3f(0, 0, -1);
        glTexCoord2f(0.0f, 0.0f);   glVertex3f( -1.0f, 1.0f, 0.0f); // TR
        glTexCoord2f(1.0f, 0.0f);   glVertex3f( 1.0f, 1.0f, 0.0f); // TL
        glTexCoord2f(1.0f, 1.0f);   glVertex3f(1.0f,  -1.0f, 0.0f); // BL
