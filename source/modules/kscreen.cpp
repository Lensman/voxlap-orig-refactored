...
__int64 mskp255 = 0x00ff00ff00ff00ff;
__int64 mskn255 = 0xff01ff01ff01ff01;
__int64 rgbmask64 = 0xffffff00ffffff;
extern long zbufoff;
 ...
 */
void drawline3d (float x0, float y0, float z0, float x1, float y1, float z1, const long col)
{
	float ox, oy, oz, r;
...
*/
void hitscan (const dpoint3d *p, const dpoint3d *d, lpoint3d *h, long **ind, long *dir)
{
 ...
 *  @return 0:always
 */
long surroundcapture32bit (const dpoint3d *pos, const char *fname, const long boxsiz)
{
	lpoint3d hit;
	dpoint3d d;
