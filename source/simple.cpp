...
long initapp (long argc, char **argv)
{
	...
	#elif VSID == 1024
		char * vox2load = "vxl/test-1024x256.vxl";
	#endif	
	char * png2load = "png/test-1024x1024.png";
	//loadpng(png2load,&ipos,&istr,&ihei,&ifor);
	loadvxl(vox2load,&ipos,&istr,&ihei,&ifor);
   
    desklamp.voxnum = getkv6("kv6\\desklamp.kv6");
	desklamp.p.x = 256.0f; desklamp.p.y = 256.0f; desklamp.p.z = 32.5f;
	desklamp.s.x = 2.4f; desklamp.s.y = 0.0f; desklamp.s.z = 0.0f;
	desklamp.h.x = 0.0f; desklamp.h.y = 2.4f; desklamp.h.z = 0.0f;
	desklamp.f.x = 0.0f; desklamp.f.y = 0.0f; desklamp.f.z = 2.4f;
	desklamp.kfatim = 0; desklamp.okfatim = 0; desklamp.flags = 4;
